...
@section('content')
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover datatable compact datatable-Role">
            <thead>
            ...
            @foreach($roles as $key => $role)
                <tr data-entry-id="{{ $role->id }}">
                    ...
                    <td class="text-center">
                        <a class="btn btn-xs text-xs btn-primary" href="{{ route('roles.edit', $role->id) }}">
                            Editar
                        </a>

                        <form action="{{ route('roles.destroy', $role->id) }}" method="POST" onsubmit="return confirm('¿ Está seguro ?');" style="display: inline-block;">
