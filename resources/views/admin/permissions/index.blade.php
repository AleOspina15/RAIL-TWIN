...
@section('content')
    <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable compact datatable-Permission">
                    <thead>
                    ...
                    @foreach($permissions as $key => $permission)
                        <tr data-entry-id="{{ $permission->id }}">
                            ...
                            <td class="text-center">
                                <a class="btn btn-xs text-xs btn-primary" href="{{ route('permissions.edit', $permission->id) }}">
                                    Editar
                                </a>
                                <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" onsubmit="return confirm('¿ Está seguro ?');" style="display: inline-block;">
