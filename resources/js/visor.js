...
var f_obj = {
    ...
    visorPotree: function (layer) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                console.log("http://" + ip_server + "/potree/" + workspace + "_" + id_capa + "/" + workspace + "_" + id_capa + ".html");
                if (data[0] === 'Ok') {
                ...
                if (data.length > 0) {
                    ...
                    for (var x = 0; x < data.length; x++) {
                        ...
                        if (x === data.length - 1) {
                            ...
                            console.log("Agregando: "+data[x]['id_grupo']);
...
function zoomToArea(){
    let center = olProj.fromLonLat([38.972589849810326, -0.18575430976532462]);
    let zoom = 12;
    var view = map.getView();
