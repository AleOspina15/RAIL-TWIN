...
class Elfinder2Controller extends Controller
{
    ...
    {
        $currenturl = url()->full();
        $path = explode("&",explode("path=",$currenturl)[1])[0];
        $path = str_replace("%2F","/",$path);
        $path = str_replace("%20"," ",$path);
        $startPath = explode("&",explode("startPath=",$currenturl)[1])[0];
        $startPath = str_replace("%2F","/",$startPath);
        $startPath = str_replace("%20"," ",$startPath);

        //return [$currenturl,$path,$startPath];
...
*/
    ...
    public function showConnectorPost(Request $request)
    {
        $path = $request->path;
        $path = str_replace("%2F","/",$path);
        $path = str_replace("%20"," ",$path);
