...
<?php $__env->startSection('content'); ?>
    <input type="hidden" id="json" name="json" value="<?php echo e($json); ?>" />
    <input type="hidden" id="id_p" name="id_p" value="<?php echo e($id); ?>" />
    ...
    <div class="row m-0 p-0">
        ...
        <div class="col-12 m-0 p-0">
            <div id="zoom_btns">
                <button id="btn-zoom-Esp" class="btn btn-secondary">España</button>
                <button id="btn-zoom-AvMad" class="btn btn-secondary">Ávila - Madrid</button>
                <button id="btn-zoom-AvVall" class="btn btn-secondary">Ávila - Valladolid</button>
                <button id="btn-zoom-BurMir" class="btn btn-secondary">Burgos - Miranda del Ebro</button>
            </div>
...
<?php $__env->startSection('css'); ?>
    ...
    <link href="<?php echo e(asset('vendor/winbox/dist/css/winbox.min.css')); ?>" rel="stylesheet" />

    <link rel="stylesheet" href="<?php echo e(asset('css/visor.css')); ?>">
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('js/visor2.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/visor2.blade.php ENDPATH**/ ?>