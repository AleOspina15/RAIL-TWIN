    ...
    <div class="container-fluid">
        <div class="row mb-1">
            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
                <h4 class="text-sidap text-bold m-0"><i class="fa-solid fa-toolbox"></i> Editar Proyecto</h4>
            </div>
...
<?php $__env->startSection('content'); ?>
    <input id="coord" name="coord" type="hidden" value="<?php echo e($proyecto->coord); ?>">
    <input id="id_proyecto" name="id_proyecto" type="hidden" value="<?php echo e($proyecto->id); ?>">

    <input id="bbox1" name="bbox1" type="hidden" value="">
    <input id="bbox2" name="bbox2" type="hidden" value="">
    <input id="bbox3" name="bbox3" type="hidden" value="">
    <input id="bbox4" name="bbox4" type="hidden" value="">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form>
                ...
                <div class="mt-2">
                    <a href="javascript:void(0)" onclick="f_obj.actualizarProyecto()" class="btn btn-danger">Guardar</a>
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('js/proyectos_edit.js')); ?>"></script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/admin/proyectos/edit.blade.php ENDPATH**/ ?>